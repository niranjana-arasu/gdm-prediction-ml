...
Exploratory Data Analysis (EDA) — distribution analysis, missing value treatment, correlation heatmaps
Data Preprocessing — feature scaling (StandardScaler), handling class imbalance, train/test split (80/20)
Model Training & Comparison — three classifiers trained and evaluated:
...
Results
ModelAccuracyNotesLogistic RegressionBaselineUsed as interpretable reference modelSupport Vector Machine—Evaluated across kernel typesRandom Forest>80%Best performing model
